...
namespace rabitqlib {
  ...
  struct ExDataMap {
   public:
    ...
    [[nodiscard]] uint8_t *ex_code() {
      return ex_code_;
    }
    [[nodiscard]] T &f_add_ex() {
      return f_add_ex_;
    }
    [[nodiscard]] T &f_rescale_ex() {
      return f_recale_ex_;
    }
  ...
  struct ConstExDataMap {
   public:
    ...
    [[nodiscard]] const uint8_t *ex_code() const {
      return ex_code_;
    }
    [[nodiscard]] const T &f_add_ex() const {
      return f_add_ex_;
    }
    [[nodiscard]] const T &f_rescale_ex() const {
      return f_recale_ex_;
    }
  ...
  struct BinDataMap {
   public:
    explicit BinDataMap(char *data, size_t padded_dim)
        : bin_code_(reinterpret_cast<uint64_t *>(data)), f_add_(*reinterpret_cast<T *>(data + (padded_dim / 8))),
          f_rescale_(*(reinterpret_cast<T *>(data + (padded_dim / 8)) + 1)),
          f_error_(*(reinterpret_cast<T *>(data + (padded_dim / 8)) + 2)) {
    }

    [[nodiscard]] uint64_t *bin_code() {
      return bin_code_;
    }
    [[nodiscard]] T &f_add() {
      return f_add_;
    }
    [[nodiscard]] T &f_rescale() {
      return f_rescale_;
    }
    [[nodiscard]] T &f_error() {
      return f_error_;
  ...
  struct ConstBinDataMap {
   public:
    ...
    [[nodiscard]] const uint64_t *bin_code() {
      return bin_code_;
    }
    [[nodiscard]] const T &f_add() {
      return f_add_;
    }
    [[nodiscard]] const T &f_rescale() {
      return f_rescale_;
    }
    [[nodiscard]] const T &f_error() {
      return f_error_;
    }
